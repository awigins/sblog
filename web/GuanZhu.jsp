			...
			<div class="container">
				...
				<section class="post_content">
					...
					<div class="links">
						...
						<div class="userItems">
							<c:forEach items="${MyFocusList}" var="user">
								<div class="userItem">
									<div class="userItem--inner">
										<div class="userItem-content"><img alt='' src="${user.image}" class='avatar avatar-64 photo' height='64' width='64' />
											<div class="userItem-name">
												<a class="link link--primary" href="userdetail?id=${user.id}" target="_blank">Akina${user.userNick}</a>
											</div>
										</div>
									</div>
								</div>
